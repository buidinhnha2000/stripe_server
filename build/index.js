...
app.post('/pay-without-webhooks', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, paymentMethodId, paymentIntentId, items, currency, useStripeSdk, cvcToken, email, price, orderAmount, secret_key, stripe, customers, paymentMethods, params, intent, params, intent, intent, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, paymentMethodId = _a.paymentMethodId, paymentIntentId = _a.paymentIntentId, items = _a.items, currency = _a.currency, useStripeSdk = _a.useStripeSdk, cvcToken = _a.cvcToken, email = _a.email, price = _a.price;
